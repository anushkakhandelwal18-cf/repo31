...
/**
 * The Trdpb000 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpb000 trdpb000 = (Trdpb000) context.getBean("trdpb000");
				...
				trdpb000.setParameter(new GlobalExecutorCtx().getContext(Trdpb000Ctx.class),inputValue);

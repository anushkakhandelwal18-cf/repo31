...
/**
 * The Trdpb001 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpb001 trdpb001 = (Trdpb001) context.getBean("trdpb001");
				...
				trdpb001.setParameter(new GlobalExecutorCtx().getContext(Trdpb001Ctx.class),inputValue);
